...
def astar_search(graph, heuristics, start, end):
    ...
    while len(open) > 0:
        ...
        for key, value in neighbors.items():
            ...
            neighbor.h = heuristics.get(current_node.name,neighbor.name)
...
def main():
    ...
    graph.connect('Sibiu', 'RimnicuVilcea', 80)
    graph.connect('RimnicuVilcea', 'Craiova', 146)
    graph.connect('RimnicuVilcea', 'Pitesti', 97)
    graph.connect('Criova', 'Pitesti', 138)
    ...
    graph.connect('Urzeceni', 'Vaslui', 142)
